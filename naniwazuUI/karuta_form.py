...
class Ui_mainForm(object):
    def setupUi(self, mainForm):
        ...
        self.btnStart.setGeometry(QtCore.QRect(10, 620, 75, 23))
        self.btnStart.setObjectName("btnStart")
        self.btnSave = QtWidgets.QPushButton(mainForm)
        self.btnSave.setGeometry(QtCore.QRect(90, 620, 71, 23))
        self.btnSave.setObjectName("btnSave")
        self.btnShow = QtWidgets.QPushButton(mainForm)
        self.btnShow.setGeometry(QtCore.QRect(160, 620, 71, 23))
        self.btnShow.setObjectName("btnShow")
        self.btnExit = QtWidgets.QPushButton(mainForm)
        self.btnExit.setGeometry(QtCore.QRect(360, 620, 75, 23))
        self.btnExit.setObjectName("btnExit")
        self.cbPlayer = QtWidgets.QComboBox(mainForm)
        self.cbPlayer.setGeometry(QtCore.QRect(240, 620, 91, 22))
